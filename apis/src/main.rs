...
async fn main() -> std::io::Result<()> {
    ...
    use api::v1::bot::{games::{api_get_game, api_get_game_requests, api_get_ongoing_games, api_get_pending_games}, play::{api_control, api_play}, challenges::{api_accept_challenge, api_create_challenge, api_delete_challenge, api_get_challenges}, tournaments::api_get_tournament};
